...
const features = [
  {
    ...
    description: "Fast pre-filters catch flash-loan drain patterns, reserve ratio spikes, and same-block profit extraction before deeper analysis runs.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Anomaly ensemble",
    description: "IsolationForest plus statistical models flag abnormal protocol behavior with the current 97.08% detection benchmark.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Counterfactual simulation",
    description: "Fork current state, execute the suspicious transaction in a sandbox, and compute Protocol Impact Score from TVL before and after.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Protocol invariants",
    description: "AMM, money market, and perp-specific checks verify whether the transaction breaks the rules that actually protect funds.",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Patterns are noisy.
            <br />
            <span className="text-muted-foreground">Outcomes are harder to fake.</span>
          </h2>
        </div>
